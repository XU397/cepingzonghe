...
export const PAGE_MAPPING = {
  ...
  1: { desc: '蜂蜜的奥秘', navigationMode: 'experiment', totalPages: 12, pageId: 'Page_01_Intro' },
  2: { desc: '提出问题', navigationMode: 'experiment', totalPages: 12, pageId: 'Page_02_Question' },
  3: { desc: '资料阅读', navigationMode: 'experiment', totalPages: 12, pageId: 'Page_03_Resource' },
  4: {
    desc: '假设陈述',
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_04_Hypothesis',
  },
  5: { desc: '方案设计', navigationMode: 'experiment', totalPages: 12, pageId: 'Page_05_Design' },
  6: {
    desc: '方案评估',
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_06_Evaluation',
  },
  7: { desc: '过渡页', navigationMode: 'experiment', totalPages: 12, pageId: 'Page_07_Transition' },
  8: {
    desc: '模拟实验',
    navigationMode: 'experiment',
    totalPages: 12,
  ...
  9: {
    ...
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_09_Analysis1',
  },
  10: {
    desc: '实验分析2',
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_10_Analysis2',
  },
  11: {
    desc: '实验分析3',
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_11_Analysis3',
  },
  12: {
    desc: '方案选择',
    navigationMode: 'experiment',
    totalPages: 12,
    pageId: 'Page_12_Solution',
  },
  13: { desc: '任务总结', navigationMode: 'hidden', pageId: 'Page_13_Summary' },
  ...
  15: {
    ...
    navigationMode: 'questionnaire',
    totalPages: 8,
    pageId: 'Questionnaire_02',
  },
  16: {
    desc: '问卷调查第3页',
    navigationMode: 'questionnaire',
    totalPages: 8,
    pageId: 'Questionnaire_03',
  },
  17: {
    desc: '问卷调查第4页',
    navigationMode: 'questionnaire',
    totalPages: 8,
    pageId: 'Questionnaire_04',
  },
  18: {
    desc: '问卷调查第5页',
    navigationMode: 'questionnaire',
    totalPages: 8,
    pageId: 'Questionnaire_05',
  },
  19: {
    desc: '问卷调查第6页',
    navigationMode: 'questionnaire',
