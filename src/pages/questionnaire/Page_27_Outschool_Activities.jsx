...
function Page_27_Outschool_Activities() {
  ...
  useEffect(() => {
    ...
    if (isActualTimeout && !isSubmitting && !timeoutHandledRef.current) {
  ...
  }, [isQuestionnaireTimeUp, isSubmitting, questionnaireRemainingTime]);

  return (
    <div className={styles.pageContainer}>
      <div className={styles.questionnaireContent}>
        <p className={styles.pageDescription}>
          请选择你参与以下各项<span style={{ color: 'red' }}>校外</span>科学活动的频率。
        </p>
